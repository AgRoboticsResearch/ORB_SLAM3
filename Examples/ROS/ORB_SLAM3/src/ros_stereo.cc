...
int main(int argc, char **argv)
{
    ...
    std::cout << "do_rectify: " << argv[3] << std::endl;
    bool do_rectify = argv[3];

    // Create SLAM system. It initializes all system threads and gets ready to process frames.
    ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::STEREO,do_rectify);
    std::cout << "SLAM system initialzied STEREO" << std::endl;

    ImageGrabber igb(&SLAM);
    std::cout << "igb.do_rectify: " << igb.do_rectify << std::endl;
